...
n_easy = 10   # 10 practitioners
n_medium = 5 # 25 practitioners
n_hard = 3   # 40 practitioners
...
for x in range(n_easy):
    start = random.randint(0, len(patients) - 10)
    print(" ".join(patients[start: start+10]))

for x in range(n_medium):
    start = random.randint(0, len(patients) - 25)
    print(" ".join(patients[start: start+25]))

for x in range(n_hard):
    start = random.randint(0, len(patients) - 40)
    print(" ".join(patients[start: start+40]))
